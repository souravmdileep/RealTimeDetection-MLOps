...
# 3. V2: YOLOv8 Medium (Standard ONNX)
...
# Export to Standard ONNX (Removes int8=True which caused the crash)
# This automatically creates: /app/backend/models/v2/yolov8m.onnx
